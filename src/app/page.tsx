  ...
  return (
    <ErrorBoundary level="page" context="Journal App">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 flex flex-col max-w-3xl ml-auto w-full px-6">
          {/* Header */}
          ...
          {/* Coaching Cards - AI Error Boundary */}
          <AIErrorBoundary>
      ...
      <div className="w-64 flex-shrink-0 flex flex-col px-6">
      ...
      {/* Modals - Component level boundaries */}
