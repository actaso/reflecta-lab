      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex-shrink-0">
          <button
            ...
            disabled={loading}
            className="px-4 py-2 bg-neutral-100 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-200 rounded-lg text-sm font-medium hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
